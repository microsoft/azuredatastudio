...
export class AzdataTool implements azdataExt.IAzdataApi {
	...
	public arc = {
		dc: {
			create: (namespace: string, name: string, connectivityMode: string, resourceGroup: string, location: string, subscription: string, profileName?: string, storageClass?: string, additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<void>> => {
			...
			endpoint: {
				list: (additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.DcEndpointListResult[]>> => {
					return this.executeCommand<azdataExt.DcEndpointListResult[]>(['arc', 'dc', 'endpoint', 'list'], additionalEnvVars);
				}
			},
			config: {
				list: (additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.DcConfigListResult[]>> => {
					return this.executeCommand<azdataExt.DcConfigListResult[]>(['arc', 'dc', 'config', 'list'], additionalEnvVars);
				},
				show: (additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.DcConfigShowResult>> => {
		...
		postgres: {
			server: {
				delete: (name: string, additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<void>> => {
					return this.executeCommand<void>(['arc', 'postgres', 'server', 'delete', '-n', name, '--force'], additionalEnvVars);
				},
				list: (additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.PostgresServerListResult[]>> => {
					return this.executeCommand<azdataExt.PostgresServerListResult[]>(['arc', 'postgres', 'server', 'list'], additionalEnvVars);
				},
				show: (name: string, additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.PostgresServerShowResult>> => {
		...
		sql: {
			mi: {
				...
				list: (additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.SqlMiListResult[]>> => {
					return this.executeCommand<azdataExt.SqlMiListResult[]>(['arc', 'sql', 'mi', 'list'], additionalEnvVars);
				},
				show: (name: string, additionalEnvVars?: { [key: string]: string }): Promise<azdataExt.AzdataOutput<azdataExt.SqlMiShowResult>> => {
