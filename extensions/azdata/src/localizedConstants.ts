...
export const currentlyInstalledVersionIsLatest = (latestVersion: string, currentVersion: string): string => localize('azdata.currentlyInstalledVersionIsLatest', "Latest version available of azdata:{0}, is not newer than currently installed:{1}", latestVersion, currentVersion);
