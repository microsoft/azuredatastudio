...
export const promptForEula = (privacyStatementUrl: string, eulaUrl: string) => localize('azdata.promptForEula', "I accept the [Microsoft Privacy Statement]({0}) and the [Azure Data CLI license terms]({1}).", privacyStatementUrl, eulaUrl);
