...
if (isTestSetupCompleted()) {
	suite('CMS integration test suite', () => {
		...
		test('Create CMS Server @REL@', async function () {
			// Should fail
		...
		test('Add and delete registered group to/from CMS server @REL@', async function () {
			await utils.assertThrowsAsync(
		...
		test('Add and delete registered server to/from CMS server @REL@', async function () {
		...
		test('Add and delete registered server to/from server group @REL@', async function () {
