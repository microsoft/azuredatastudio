...
export const learnAboutWorkerNodeSettings = localize('arc.learnAboutWorkerNodeSettings', "Learn more about adding worker nodes.");
export const learnAboutMemoryVCoresSettings = localize('arc.learnAboutMemoryVCoresSettings', "Learn more about how to scale vCore and/or memory.");
