...
export const serverGroupNodesTable = localize('arc.serverGroupNodesTable', "Server group nodesTable");
...
export const podConditionsTable = localize('arc.podConditionsTable', "Pod condition table.");
