...
export const projectDetailsText = localize('arc.projectDetailsText', "Select the subscription to manage deployed resources and costs. Use resource groups like folders to organize and manage all your resources.");
export const sourceDetails = localize('arc.sourceDetails', "Source Details");
export const sourceDetailsText = localize('arc.sourceDetailsText', "Select a backup source and details. Additional settings will be defaulted where possible based on the the backup selected.");
export const databaseDetails = localize('arc.databaseDetails', "Database Details");
export const databaseDetailsText = localize('arc.databaseDetailsText', "Enter required settings for this database, including providing a name and a target managed instance. By default, the source instance is selected.");
