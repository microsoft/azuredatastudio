...
export const configurationInformation = localize('arc.configurationInformation', "You can configure number of vCores and storage size for worker node. Each worker node will have the same configuration. Adjust the number of vCores and memory settings for your server group.");
export const workerNodesInformation = localize('arc.workerNodeInformation', "In preview it is not possible to reduce the number of worker nodes. Please refer to documentation for more perspectives.");
...
export const computeAndStorageDescriptionPartFive = localize('arc.computeAndStorageDescriptionPartFive', "there is sufficient resources available");
...
export const workerNodeCount = localize('arc.workerNodeCount', "Worker nodes count:");
export const configurationPerNode = localize('arc.configurationPerNode', "Configuration (per node)");
export const vCoresMax = localize('arc.vCoresMax', "vCores - max:");
export const vCoresMin = localize('arc.vCoresMin', "vCores - min:");
