...
export const extensionsAddFunction = localize('arc.extensionsAddFunction', "Some extensions must be loaded into PostgreSQL at startup time before they can be used. To edit, type in comma separated list of valid extensions: citus, pgaudit, pgautofailover, pg_cron, pg_partman, plv8, postgis, postgis_raster, postgis_sfcgal, postgis_tiger_geocoder, tdigest.");
export const extensionsAddErrorrMessage = localize('arc.extensionsAddErrorrMessage', "Value should be either of the following: citus, pgaudit, pgautofailover, pg_cron, pg_partman, plv8, postgis, postgis_raster, postgis_sfcgal, postgis_tiger_geocoder, tdigest.");
