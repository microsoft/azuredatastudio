...
export const workerNodesInformation = localize('arc.workerNodeInformation', "It is possible to scale in and out your server group by reduce or increasing the number of worker nodes.");
