...
export const enterExtensionsList = localize('arc.enterExtensionsList', "Enter a non empty comma-separated list of the Postgres extensions");
export const enterANonEmptyExtensionList = localize('arc.enterANonEmptyExtensionList', "Enter a non empty comma-separated list of the Postgres extensions or press escape to exit.");
