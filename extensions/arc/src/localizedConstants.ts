...
export function connectToSqlFailed(serverName: string, error: any): string { return localize('arc.connectToSqlFailed', "Could not connect to SQL instance - Azure Arc Instance {0}. {1}", serverName, getErrorMessage(error)); }
