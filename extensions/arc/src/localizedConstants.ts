...
export const dataStorage = localize('arc.dataStorage', "Storage Data Size (in GB):");
export const logsStorage = localize('arc.logsStorage', "Storage Logs Size (in GB):");
export const backupsStorage = localize('arc.backupsStorage', "Storage Backups Size (in GB):");
