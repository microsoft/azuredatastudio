...
export class PostgresOverviewPage extends DashboardPage {
	...
	protected get container(): azdata.Component {
		...
		content.addItem(this.propertiesLoading, { CSSStyles: { ...cssStyles.text, 'font-size': '20px' } });

		// Service endpoints
		const titleCSS = { ...cssStyles.title, 'margin-block-start': '2em', 'margin-block-end': '1em' };
