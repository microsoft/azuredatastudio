...
export class PostgresConnectionStringsPage extends DashboardPage {
	...
	private getConnectionStrings(): KeyValue[] {
		...
		return [
			...
			new InputKeyValue(this.modelView.modelBuilder, 'Web App', `Database=postgres; Data Source=${endpoint.ip}; Port=${endpoint.port}; User Id=postgres; Password={your_password_here}; Ssl Mode=Require`)
		];
	}
