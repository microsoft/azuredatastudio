...
export class PostgresCoordinatorNodeParametersPage extends DashboardPage {
	...
	protected get container(): azdata.Component {
		...
		content.addItem(this.modelView.modelBuilder.text().withProps({
			value: loc.coordinatorNodeParameters,
			CSSStyles: { ...cssStyles.title }
		}).component());

		content.addItem(this.modelView.modelBuilder.text().withProps({
			value: loc.coordinatorNodeParametersDescription,
