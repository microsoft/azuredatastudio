...
$conn = sqlsrv_connect($serverName, $connectionInfo);`),
			...
			new InputKeyValue(this.modelView.modelBuilder, 'Web App', `Database=master; Data Source=${externalEndpoint.ip}; Port=${externalEndpoint.port}; User Id=${username}; Password={your_password_here}; Ssl Mode=Require`)
		];
	}
