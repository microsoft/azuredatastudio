...
export const INVALID_FILENAME_ERROR = localize('sql.migration.invalid.fileName.error', "Please select a file name to proceed.");
...
export const BLOB_CONTAINER_FILE_NAME = localize('sql.migration.blob.container.file.name.label', "File Name");
...
export const LAST_BACKUP_FILE = localize('sql.migration.last.backup.file', "Last backup file");
