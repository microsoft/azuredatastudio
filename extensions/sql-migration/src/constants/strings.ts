...
export const DATABASE_BACKUP_SQL_VM_PAGE_BLOB_INFO = localize('sql.migration.sql.vm.page.blob.info', "For source servers running SQL Server 2014 or below, only the Azure Storage Blob Container scenario is supported. Additionally, please ensure that your backups are uploaded as page blobs instead of block blobs. Learn more: {0}");
export const DATABASE_BACKUP_SQL_VM_PAGE_BLOB_URL_LABEL = localize('sql.migration.sql.vm.page.blob.url.label', "SQL Server backup to URL for Microsoft Azure Blob Storage");
