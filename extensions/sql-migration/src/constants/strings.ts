...
export const NO_ISSUES_FOUND_VM = localize('sql.migration.no.issues.vm', "No isues found for migrating to SQL Server on Azure Virtual Machine");
export const NO_ISSUES_FOUND_MI = localize('sql.migration.no.issues.mi', "No isues found for migrating to SQL Server on Azure SQL Managed Instance");
