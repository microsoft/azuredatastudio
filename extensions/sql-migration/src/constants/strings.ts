...
export const ASSESSMENT_IN_PROGRESS_CONTENT = localize('sql.migration.assessment.in.progress.content', "We are assessing the selected databases in your SQL server instance {0} to identify the right Azure SQL target.\nThis may take some time.");
