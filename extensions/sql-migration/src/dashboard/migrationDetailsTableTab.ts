...
export class MigrationDetailsTableTab extends MigrationDetailsTabBase<MigrationDetailsTableTab> {
	...
	private async _loadData(): Promise<void> {
		...
		this._updateInfoFieldValue(this._objectsCollectionCountInfoField, objectCollection === undefined ? EmptySettingValue : objectCollection.totalCountOfObjectsCollected.toString());
		...
		this._updateInfoFieldValue(this._succeededScriptCountInfoField, scriptGeneration === undefined ? EmptySettingValue : scriptGeneration.scriptedObjectsCount.toString());
		this._updateInfoFieldValue(this._failedScriptCountInfoField, scriptGeneration === undefined ? EmptySettingValue : scriptGeneration.scriptedObjectsFailedCount.toString());
		...
		this._updateInfoFieldValue(this._succeededDeploymentCountInfoField, scriptDeployment === undefined ? EmptySettingValue : scriptDeployment.succeededDeploymentCount.toString());
		this._updateInfoFieldValue(this._failedDeploymentCountInfoField, scriptDeployment === undefined ? EmptySettingValue : scriptDeployment.failedDeploymentCount.toString());
