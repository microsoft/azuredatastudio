...
declare module 'azurecore' {
	...
	export interface IExtension {
		...
		getManagedDatabases(account: azdata.Account, subscription: azureResource.AzureResourceSubscription, managedInstance: azureResource.AzureGraphResource, ignoreErrors?: boolean): Promise<GetManagedDatabasesResult>;
