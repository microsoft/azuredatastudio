...
export async function activate(context: vscode.ExtensionContext): Promise<azurecore.IExtension> {
	...
	return {
		...
		getSelectedSubscriptions(account?: azdata.Account, ignoreErrors?: boolean): Thenable<azurecore.GetSubscriptionsResult> { return azureResourceUtils.getSelectedSubscriptions(appContext, account, ignoreErrors); },
