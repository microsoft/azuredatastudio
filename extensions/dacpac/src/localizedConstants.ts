...
export function deployOperationErrorMessage(errorMessage: string): string { return localize('dacfx.deployOperationErrorMessage', "Deploy operation failed '{0}'", errorMessage ? errorMessage : 'Unknown'); }
export function extractOperationErrorMessage(errorMessage: string): string { return localize('dacfx.extractOperationErrorMessage', "Extract operation failed '{0}'", errorMessage ? errorMessage : 'Unknown'); }
export function importOperationErrorMessage(errorMessage: string): string { return localize('dacfx.importOperationErrorMessage', "Import operation failed '{0}'", errorMessage ? errorMessage : 'Unknown'); }
export function exportOperationErrorMessage(errorMessage: string): string { return localize('dacfx.exportOperationErrorMessage', "Export operation failed '{0}'", errorMessage ? errorMessage : 'Unknown'); }
