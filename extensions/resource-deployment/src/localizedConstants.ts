...
export const scriptToNotebookButtonLabel = localize('eulaWizard.ScriptToNotebook', "Script to Notebook");
export const autoSummaryPageTitle = localize('eulaWizard.autoSummaryPageTitle', "Review your configuration");
export const eulaSettingsPageTitle = localize('eulaWizard.eulaSettingsPageTitle', "Deployment pre-requisites");
export const installToolsButtonLabel = localize('eulaWizard.installToolsButtonLabel', "Install tools");
export const validateEulaButtonLabel = localize('eulaSettingsPage.ValidateEULALabel', "Validate EULA");
export const eulaSettingsAgreementNotCheckedError = localize('eulaSettingsPage.agreementNotCheckedError', "You must agree to the license agreeements in order to proceed.");
export const eulaSettingsagreementCheckboxLabel = localize('eulaSettingsPage.agreementCheckboxLabel', "Accept terms of use");
export const toolNameColumnHeader = localize('eulaSettingsPage.toolNameColumnHeader', "Tool");
export const toolDescriptionColumnHeader = localize('eulaSettingsPage.toolDescriptionColumnHeader', "Description");
export const toolStatusColumnHeader = localize('eulaSettingsPage.toolStatusColumnHeader', "Status");
export const toolVersionColumnHeader = localize('eulaSettingsPage.toolVersionColumnHeader', "Version");
export const toolMinimumVersionColumnHeader = localize('eulaSettingsPage.toolMinimumVersionColumnHeader', "Required Version");
export const toolDiscoveredPathColumnHeader = localize('eulaSettingsPage.toolDiscoveredPathColumnHeader', "Discovered Path or Additional Information");
export const RequiredToolsTitle = localize('eulaSettingsPage.RequiredToolsTitle', "Required tools");
export const loadingRequiredToolsCompleted = localize('eulaSettingsPage.loadingRequiredToolsCompleted', "Loading required tools information completed");
export const loadingRequiredTools = localize('eulaSettingsPage.loadingRequiredTools', "Loading required tools information");
export const installedTools = localize('eulaSettingsPage.InstalledTools', "All required tools are installed now.");
export const noRequiredTool = localize('eulaSettingsPage.NoRequiredTool', "No tools required");
