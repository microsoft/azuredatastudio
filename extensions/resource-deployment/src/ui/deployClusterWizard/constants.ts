...
export const MasterSQLServerScale_VariableName = 'AZDATA_NB_VAR_BDC_MASTERSQL_SCALE';
export const StoragePoolScale_VariableName = 'AZDATA_NB_VAR_BDC_STORAGEPOOL_SCALE';
