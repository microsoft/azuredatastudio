...
import { ArcDeploymentType, BdcDeploymentType } from '../../interfaces';
...
import * as VariableNames from '../deployClusterWizard/constants';
import { ToolsInstallPath } from './../../constants';


export class NotebookWizardModel extends Model {
	constructor(public deploymentTarget: ArcDeploymentType | BdcDeploymentType) {
		super();
	}
	...
	private setStorageSettingValues(): void {
		// TODO
		this.setStorageSettingValue('foo', 'bar');
	}
