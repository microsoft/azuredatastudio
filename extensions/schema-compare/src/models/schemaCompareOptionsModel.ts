...
export class SchemaCompareOptionsModel {
	...
	public objectsLookup: Map<string, boolean> = new Map<string, boolean>();
	...
	*/
	...
	public setDeploymentOptions() {
		for (let option of this.optionsLookup) {
			...
			return this.optionsMapTable.set(option[0], optionProp);
		}
	}
	...
	public setObjectTypeOptions() {
		for (let option of this.objectsLookup) {
			this.setSchemaCompareIncludedObjectsUtil(option[0], option[1]);
		}
