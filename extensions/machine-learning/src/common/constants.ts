...
export const sqlMlExtDocDesc = localize('sqlMlExtDocDesc', "Learn how to use the Machine Learning extension in Azure Data Studio, to manage packages, make predictions, and import models.");
