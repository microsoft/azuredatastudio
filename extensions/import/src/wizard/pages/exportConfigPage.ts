...
export class ExportConfigPage extends DacFxPage {
	...
	private async createServerDropdown(): Promise<sqlops.FormComponent> {
		...
		return {
			...
			title: localize('dacFxExport.serverDropdownTitle', 'Source Server')
		};
	}
	...
	private async createDatabaseDropdown(): Promise<sqlops.FormComponent> {
		...
		return {
			...
			title: localize('dacFxExport.databaseDropdownTitle', 'Source Database')
		};
	}
	...
	private async createFileBrowser(): Promise<sqlops.FormComponent> {
		...
		return {
			...
			title: localize('dacFxExport.fileTextboxTitle', 'Bacpac location'),
