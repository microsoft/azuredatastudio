...
export const browseFileAriaLabel = localize('flatFileImport.browseFileAriaLabel', "Browse for a file to import");
...
export const fileTextboxArialabel = localize('flatFileImport.fileTextboxArailabel', "Location of the file to be imported, you can also use the browse button below to select a file");
