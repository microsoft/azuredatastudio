...
export const serverPasswordNumber = localize('serverPasswordNumber', "SQL Server admin password");
export const confirmServerPasswordNumber = localize('confirmServerPasswordNumber', "Confirm SQL Server admin password");
