...
export const azureDevOpsLink = 'https://review.docs.microsoft.com/azure/azure-sql/database/local-dev-experience-overview?view=azuresql&branch=release-build-sqldb-dev-exp';
