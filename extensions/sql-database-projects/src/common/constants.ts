...
export const dataSource = localize('dataSource', "Data Source");
export const fileFormat = localize('fileFormat', "File Format");
export const externalStream = localize('externalStream', "External Stream");
