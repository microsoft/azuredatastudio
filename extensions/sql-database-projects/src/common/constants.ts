...
export const profileWarningText = localize('profileWarningText', "⚠Warning: Only target connection, database name and SQLCMD variables are able to be loaded from a profile at this time");
