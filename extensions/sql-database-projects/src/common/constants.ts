...
export const containerAlreadyExistForProject = localize('containerAlreadyExistForProject', "Other servers on containers already exist for the project. Do you want to delete them?");
