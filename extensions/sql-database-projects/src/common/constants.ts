...
export const IncludeObjectTypeTab = localize('includeObjectTypes', 'Include Object Types');
...
export const DatabaseScopedCredentials: string = localize('DatabaseScopedCredentials', "DatabaseScopedCredentials");
