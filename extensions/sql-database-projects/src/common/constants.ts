...
export const ousiderFolderPath = localize('outsideFolderPath', "Files are added to project file with absolute paths outside of projects drive. please make the path relative and add files from the same drive");
