...
export const ousiderFolderPath = localize('outsideFolderPath', "Files are added to project file with absolute paths outside of project folder. Please make the file paths relative to project folder.");
