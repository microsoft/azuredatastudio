...
export class ProjectsController {
	...
	*/
	...
	public async createProjectFromDatabaseApiCall(model: ImportDataModel): Promise<void> {
		...
		if (azdataApi) {
			await (service as mssql.IDacFxService).createProjectFromDatabase(model.database, model.filePath, model.projName, model.version, model.connectionUri, model.extractTarget as mssql.ExtractTarget, azdataApi.TaskExecutionMode.execute, model.importPermissions);
		} else {
