...
export default class MainController implements vscode.Disposable {
	...
	private async initializeDatabaseProjects(): Promise<void> {
		...
		vscode.commands.registerCommand('sqlDatabaseProjects.getProjectDatabaseSchemaProvider', async (projectFilePath: string): Promise<string> => { return await this.projectsController.getProjectDatabaseSchemaProvider(projectFilePath); });
