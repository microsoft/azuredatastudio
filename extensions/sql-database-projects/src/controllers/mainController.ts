...
export default class MainController implements vscode.Disposable {
	...
	private async initializeDatabaseProjects(): Promise<void> {
		...
		this.context.subscriptions.push(vscode.commands.registerCommand('sqlDatabaseProjects.editSqlCmdVar', async (node: WorkspaceTreeItem) => { return this.projectsController.editSqlCmdVariable(node); }));
