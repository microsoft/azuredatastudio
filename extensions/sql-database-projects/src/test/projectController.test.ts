	...
	describe('project controller operations', function (): void {
		...
		describe('Publishing and script generation', function (): void {
			...
			it('Should copy dacpac to temp folder before publishing', async function (): Promise<void> {
				...
				testContext.dacFxService.setup(x => x.generateDeployScript(TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny(), TypeMoq.It.isAny())).returns(async (p) => {
