...
declare module 'mssql' {
	...
	*/
	...
	export interface IDacFxService {
		...
		createProjectFromDatabase(databaseName: string, targetFilePath: string, applicationName: string, applicationVersion: string, ownerUri: string, extractTarget: ExtractTarget, taskExecutionMode: azdata.TaskExecutionMode, importPermissions?: boolean): Thenable<DacFxResult>;
