...
export interface DacDeployOptionsBoolean {
	value: boolean;
	description: string;
}

export interface DeploymentOptions {
	ignoreTableOptions: DacDeployOptionsBoolean;
	ignoreSemicolonBetweenStatements: DacDeployOptionsBoolean;
	ignoreRouteLifetime: DacDeployOptionsBoolean;
	ignoreRoleMembership: DacDeployOptionsBoolean;
	ignoreQuotedIdentifiers: DacDeployOptionsBoolean;
	ignorePermissions: DacDeployOptionsBoolean;
	ignorePartitionSchemes: DacDeployOptionsBoolean;
	ignoreObjectPlacementOnPartitionScheme: DacDeployOptionsBoolean;
	ignoreNotForReplication: DacDeployOptionsBoolean;
	ignoreLoginSids: DacDeployOptionsBoolean;
	ignoreLockHintsOnIndexes: DacDeployOptionsBoolean;
	ignoreKeywordCasing: DacDeployOptionsBoolean;
	ignoreIndexPadding: DacDeployOptionsBoolean;
	ignoreIndexOptions: DacDeployOptionsBoolean;
	ignoreIncrement: DacDeployOptionsBoolean;
	ignoreIdentitySeed: DacDeployOptionsBoolean;
	ignoreUserSettingsObjects: DacDeployOptionsBoolean;
	ignoreFullTextCatalogFilePath: DacDeployOptionsBoolean;
	ignoreWhitespace: DacDeployOptionsBoolean;
	ignoreWithNocheckOnForeignKeys: DacDeployOptionsBoolean;
	verifyCollationCompatibility: DacDeployOptionsBoolean;
	unmodifiableObjectWarnings: DacDeployOptionsBoolean;
	treatVerificationErrorsAsWarnings: DacDeployOptionsBoolean;
	scriptRefreshModule: DacDeployOptionsBoolean;
	scriptNewConstraintValidation: DacDeployOptionsBoolean;
	scriptFileSize: DacDeployOptionsBoolean;
	scriptDeployStateChecks: DacDeployOptionsBoolean;
	scriptDatabaseOptions: DacDeployOptionsBoolean;
	scriptDatabaseCompatibility: DacDeployOptionsBoolean;
	scriptDatabaseCollation: DacDeployOptionsBoolean;
	runDeploymentPlanExecutors: DacDeployOptionsBoolean;
	registerDataTierApplication: DacDeployOptionsBoolean;
	populateFilesOnFileGroups: DacDeployOptionsBoolean;
	noAlterStatementsToChangeClrTypes: DacDeployOptionsBoolean;
	includeTransactionalScripts: DacDeployOptionsBoolean;
	includeCompositeObjects: DacDeployOptionsBoolean;
	allowUnsafeRowLevelSecurityDataMovement: DacDeployOptionsBoolean;
	ignoreWithNocheckOnCheckConstraints: DacDeployOptionsBoolean;
	ignoreFillFactor: DacDeployOptionsBoolean;
	ignoreFileSize: DacDeployOptionsBoolean;
	ignoreFilegroupPlacement: DacDeployOptionsBoolean;
	doNotAlterReplicatedObjects: DacDeployOptionsBoolean;
	doNotAlterChangeDataCaptureObjects: DacDeployOptionsBoolean;
	disableAndReenableDdlTriggers: DacDeployOptionsBoolean;
	deployDatabaseInSingleUserMode: DacDeployOptionsBoolean;
	createNewDatabase: DacDeployOptionsBoolean;
	compareUsingTargetCollation: DacDeployOptionsBoolean;
	commentOutSetVarDeclarations: DacDeployOptionsBoolean;
	blockWhenDriftDetected: DacDeployOptionsBoolean;
	blockOnPossibleDataLoss: DacDeployOptionsBoolean;
	backupDatabaseBeforeChanges: DacDeployOptionsBoolean;
	allowIncompatiblePlatform: DacDeployOptionsBoolean;
	allowDropBlockingAssemblies: DacDeployOptionsBoolean;
	dropConstraintsNotInSource: DacDeployOptionsBoolean;
	dropDmlTriggersNotInSource: DacDeployOptionsBoolean;
	dropExtendedPropertiesNotInSource: DacDeployOptionsBoolean;
	dropIndexesNotInSource: DacDeployOptionsBoolean;
	ignoreFileAndLogFilePath: DacDeployOptionsBoolean;
	ignoreExtendedProperties: DacDeployOptionsBoolean;
	ignoreDmlTriggerState: DacDeployOptionsBoolean;
	ignoreDmlTriggerOrder: DacDeployOptionsBoolean;
	ignoreDefaultSchema: DacDeployOptionsBoolean;
	ignoreDdlTriggerState: DacDeployOptionsBoolean;
	ignoreDdlTriggerOrder: DacDeployOptionsBoolean;
	ignoreCryptographicProviderFilePath: DacDeployOptionsBoolean;
	verifyDeployment: DacDeployOptionsBoolean;
	ignoreComments: DacDeployOptionsBoolean;
	ignoreColumnCollation: DacDeployOptionsBoolean;
	ignoreAuthorizer: DacDeployOptionsBoolean;
	ignoreAnsiNulls: DacDeployOptionsBoolean;
	generateSmartDefaults: DacDeployOptionsBoolean;
	dropStatisticsNotInSource: DacDeployOptionsBoolean;
	dropRoleMembersNotInSource: DacDeployOptionsBoolean;
	dropPermissionsNotInSource: DacDeployOptionsBoolean;
	dropObjectsNotInSource: DacDeployOptionsBoolean;
	ignoreColumnOrder: DacDeployOptionsBoolean;
	doNotDropObjectTypes: SchemaObjectType[];
	excludeObjectTypes: SchemaObjectType[];
	ignoreTablePartitionOptions: DacDeployOptionsBoolean;
	doNotEvaluateSqlCmdVariables: DacDeployOptionsBoolean;
	disableParallelismForEnablingIndexes: DacDeployOptionsBoolean;
	disableIndexesForDataPhase: DacDeployOptionsBoolean;
	restoreSequenceCurrentValue: DacDeployOptionsBoolean;
	rebuildIndexesOfflineForDataPhase: DacDeployOptionsBoolean;
	isAlwaysEncryptedParameterizationEnabled: DacDeployOptionsBoolean;
	preserveIdentityLastValues: DacDeployOptionsBoolean;
	allowExternalLibraryPaths: DacDeployOptionsBoolean;
	allowExternalLanguagePaths: DacDeployOptionsBoolean;
	hashObjectNamesInLogs: DacDeployOptionsBoolean;
	doNotDropWorkloadClassifiers: DacDeployOptionsBoolean;
	ignoreWorkloadClassifiers: DacDeployOptionsBoolean;
	ignoreDatabaseWorkloadGroups: DacDeployOptionsBoolean;
	doNotDropDatabaseWorkloadGroups: DacDeployOptionsBoolean;
}
