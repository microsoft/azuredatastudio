...
export abstract class DialogBase<DialogResult> {
	...
	protected async setTableData(table: azdata.DeclarativeTableComponent | azdata.TableComponent, data: any[][], maxRowCount: number = DefaultMaxTableRowCount): Promise<void> {
