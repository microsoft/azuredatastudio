...
export const ValidateAndSaveChangesText: string = localize('mssql.ui.loadingDialog', "Validating and saving changes...");
export const ValidateAndCreateDatabaseText: string = localize('mssql.ui.loadingDialog', "Validating and creating database...");
