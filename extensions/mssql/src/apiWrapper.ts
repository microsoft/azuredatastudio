...
export class ApiWrapper {
	...
	public showTextDocument(document: vscode.TextDocument, column?: vscode.ViewColumn, preserveFocus?: boolean, preview?: boolean, contents?: string): Thenable<vscode.TextEditor> {
