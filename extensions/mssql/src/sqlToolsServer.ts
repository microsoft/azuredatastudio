...
import { TelemetryFeature, AgentServicesFeature, SerializationFeature, AccountFeature, SqlAssessmentServicesFeature, ProfilerFeature, TableDesignerFeature, ExecutionPlanServiceFeature, AllServerMetadataServiceFeature } from './features';
...
function getClientOptions(context: AppContext): ClientOptions {
	return {
		...
		features: [
			...
			AllServerMetadataServiceFeature,
