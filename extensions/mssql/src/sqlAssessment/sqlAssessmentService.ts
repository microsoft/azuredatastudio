...
export class SqlAssessmentService implements mssql.ISqlAssessmentService {
	...
	async assessmentInvoke(ownerUri: string, targetType: azdata.SqlAssessmentTargetType): Promise<azdata.SqlAssessmentResult | undefined> {
	...
	async getAssessmentItems(ownerUri: string, targetType: azdata.SqlAssessmentTargetType): Promise<azdata.SqlAssessmentResult | undefined> {
		let params: contracts.SqlAssessmentParams = { ownerUri: ownerUri, targetType: targetType };
		try {
