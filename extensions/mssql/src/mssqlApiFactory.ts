...
import { IExtension, ICmsService, IDacFxService, ISqlProjectsService, ISchemaCompareService, ILanguageExtensionService, ISqlAssessmentService, IAzureBlobService, IIdentificationService } from 'mssql';
...
export function createMssqlApi(context: AppContext, sqlToolsServer: SqlToolsServer): IExtension {
	return {
		...
		get identification() {
			return context.getService<IIdentificationService>(constants.IdentificationService);
		},
	};
}
