...
import { IExtension, ICmsService, IDacFxService, ISchemaCompareService, ILanguageExtensionService, ISqlAssessmentService, ISqlMigrationService, IAzureBlobService, IErrorDiagnosticsService } from 'mssql';
...
export function createMssqlApi(context: AppContext, sqlToolsServer: SqlToolsServer): IExtension {
	return {
		...
		get errorDiagnostics() {
			return context.getService<IErrorDiagnosticsService>(constants.ErrorDiagnosticsService);
		},
	};
}
