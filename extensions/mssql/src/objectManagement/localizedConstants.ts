...
export const BackupMediaOptionsLabel = localize('objectManagement.backupMediaOptions', "Media Options");
export const BackupOptionsLabel = localize('objectManagement.backupOptions', "Backup Options");
