	...
	private getDatabaseView(isNewObject: boolean, name: string): DatabaseViewInfo {
		return isNewObject ? <DatabaseViewInfo>{
			...
			objectInfo: {
				...
				files: [
					{ id: 1, name: 'databasefile1', type: 'ROWS Data', path: 'C:\\Temp\\', fileGroup: 'PRIMARY', fileNameWithExtension: 'databasefile1.mdf', sizeInMb: 62, isAutoGrowthEnabled: true, autoFileGrowth: 64, autoFileGrowthType: 'KB', maxSizeLimit: -1 },
					{ id: 2, name: 'databasefile1_Log', type: 'Log', path: 'C:\\Temp\\', fileGroup: 'Not Applicable', fileNameWithExtension: 'databasefile1_log.ldf', sizeInMb: 62, isAutoGrowthEnabled: true, autoFileGrowth: 64, autoFileGrowthType: 'KB', maxSizeLimit: -1 },
				]
			}
		}
	}
