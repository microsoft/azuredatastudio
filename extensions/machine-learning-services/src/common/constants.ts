...
export const columnName = localize('predict.columnName', "Column Name");
export const dataTypeName = localize('predict.dataTypeName', "Data Type Name");
export const inputName = localize('predict.inputName', "Input Name");
export const outputName = localize('predict.outputName', "Output Name");
