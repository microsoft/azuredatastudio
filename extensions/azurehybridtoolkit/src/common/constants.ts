...
export const jupyterNewNotebookTask = 'hybridtoolkit.task.newNotebook';
export const jupyterOpenNotebookTask = 'hybridtoolkit.task.openNotebook';
export const jupyterNewNotebookCommand = 'hybridtoolkit.cmd.newNotebook';
export const jupyterReinstallDependenciesCommand = 'hybridtoolkit.reinstallDependencies';
export const jupyterAnalyzeCommand = 'hybridtoolkit.cmd.analyzeNotebook';
export const jupyterManagePackages = 'hybridtoolkit.cmd.managePackages';
export const jupyterConfigurePython = 'hybridtoolkit.cmd.configurePython';
