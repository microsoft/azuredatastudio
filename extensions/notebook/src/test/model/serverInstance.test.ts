...
import { PerDriveServerInstance, ServerInstanceUtils } from '../../jupyter/serverInstance';
...
describe('Jupyter server instance', function (): void {
	...
	let serverInstance: PerDriveServerInstance;
	...
	beforeEach(() => {
		...
		serverInstance = new PerDriveServerInstance({
