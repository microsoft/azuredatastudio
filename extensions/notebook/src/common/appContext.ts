...
import { NavigationProviders, BOOKS_VIEWID, PROVIDED_BOOKS_VIEWID, extensionOutputChannel } from './constants';
...
export class AppContext {
	...
	public readonly outputChanel: vscode.OutputChannel;
	...
	constructor(public readonly extensionContext: vscode.ExtensionContext) {
		...
		this.outputChanel = vscode.window.createOutputChannel(extensionOutputChannel);
	}
}
