...
export const msgBookTrusted = localize('msgBookTrusted', "Book is now automatically trusted.");
export const msgBookAlreadyTrusted = localize('msgBookAlreadyTrusted', "Book is already trusted.");
