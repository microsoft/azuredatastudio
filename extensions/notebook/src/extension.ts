...
export async function activate(extensionContext: vscode.ExtensionContext): Promise<IExtensionApi> {
	...
	extensionContext.subscriptions.push(vscode.commands.registerCommand('notebook.command.pinNotebook', (book: any) => {
		bookTreeViewProvider.pinNotebook(book);
		pinnedBookTreeViewProvider.addRemoveNotebookFromPinned(book);
	}));
	extensionContext.subscriptions.push(vscode.commands.registerCommand('notebook.command.unpinNotebook', (book: any) => {
		bookTreeViewProvider.pinNotebook(book, true);
		pinnedBookTreeViewProvider.addRemoveNotebookFromPinned(book, false);
	}));
