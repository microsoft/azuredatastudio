...
export class JupyterKernel implements nb.IKernel {
	...
	requestExecute(content: nb.IExecuteRequest, disposeOnDone?: boolean): nb.IFuture {
		...
		let futureImpl = this.kernelImpl.requestExecute(content as KernelMessage.IExecuteRequest & { notebookUri: string, cellUri: string, language: string, cellIndex: number }, disposeOnDone);
