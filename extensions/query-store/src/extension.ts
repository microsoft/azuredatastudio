...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
	...
	context.subscriptions.push(vscode.commands.registerCommand('queryStore.openQueryStoreDashboard', async (selectTab?: string) => {
		const dashboard = new QueryStoreDashboard('AdventureWorks', context)
