...
declare module 'sql-bindings' {
	...
	export interface IExtension {
		 ...
		 * @param bindingType Type of SQL Binding
		 */
		promptForObjectName(bindingType: BindingType, connectionInfo?: IConnectionInfo | undefined): Promise<string | undefined>;

		/**
		 * Prompts the user to enter connection setting and updates it from AF project
		 * @param projectUri Azure Function project uri
		 */
		 promptAndUpdateConnectionStringSetting(projectUri: vscode.Uri | undefined): Promise<IConnectionStringResult | undefined>;
	...
	export interface IConnectionStringResult {
