...
export const sqlTableOrViewToQuery = localize('sqlTableOrViewToQuery', "SQL object to query");
...
export const enterSqlObjectName = localize('enterSqlObjectName', 'Enter SQL table to query');
export const enterViewsObjectName = localize('enterViewsObjectName', 'Enter SQL view to query');
export const enterSqlObjectNameToUpsert = localize('enterObjectNameToUpsert', 'Enter SQL table to upsert into');
...
export const sqlTable = localize('sqlTable', 'Table');
export const sqlView = localize('sqlView', 'View');
