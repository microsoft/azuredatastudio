...
export const missingBracket = localize('missingBracket', "Name is missing closing bracket");
export const missingQuote = localize('missingQuote', "Name is missing quote");
