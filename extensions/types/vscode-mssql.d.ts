...
declare module 'vscode-mssql' {
	...
	*/
	...
	export interface ISqlProjectsService {
		 ...
		 * @param path Path of the script, including .sql, relative to the .sqlproj
		 */
		addNoneScript(projectUri: string, path: string): Promise<ResultStatus>;
		 ...
		 * @param path Path of the script, including .sql, relative to the .sqlproj
		 */
		deleteNoneScript(projectUri: string, path: string): Promise<ResultStatus>;
		 ...
		 * @param path Path of the script, including .sql, relative to the .sqlproj
		 */
		excludeNoneScript(projectUri: string, path: string): Promise<ResultStatus>;
		 ...
		 * @param path Path of the script, including .sql, relative to the .sqlproj
		 */
		moveNoneScript(projectUri: string, destinationPath: string, path: string): Promise<ResultStatus>;
	}
