...
// import { Notebook } from './notebook'; // {{SQL CARBON EDIT}} This is for VSCode notebookds and not SQL notebooks
...
export class Workbench {
	...
	// readonly notebook: Notebook; // {{SQL CARBON EDIT}} - This is for VSCode notebookds and not SQL notebooks
	...
	constructor(code: Code) {
		...
		// {{END}}
		// this.notebook = new Notebook(this.quickaccess, code); // {{SQL CARBON EDIT}} - This is for VSCode notebookds and not SQL notebooks
