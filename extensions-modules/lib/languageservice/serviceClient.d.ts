...
export declare class SqlToolsServiceClient {
    ...
    createClient(context: ExtensionContext, runtimeId: Runtime, languageClientHelper: LanguageServiceContracts.ILanguageClientHelper, executableFiles: string[]): Promise<SqlopsClient.SqlOpsDataClient>;
     ...
     */
    sendRequest<P, R, E, RO>(type: RequestType<P, R, E, RO>, params?: P, client?: SqlopsClient.SqlOpsDataClient): Thenable<R>;
    /**
     * Register a handler for a notification type
     * @param type The notification type to register the handler for
     * @param handler The handler to register
     */
    onNotification<P, RO>(type: NotificationType<P, RO>, handler: NotificationHandler<P>, client?: SqlopsClient.SqlOpsDataClient): void;
