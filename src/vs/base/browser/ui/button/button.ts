...
export class Button extends Disposable {
	...
	// {{SQL CARBON EDIT}} -- removed 'private' access modifier @todo anthonydresser things needs investigation whether we need this
	applyStyles(): void {
		if (this._element) {
	...
	// {{SQL CARBON EDIT}} from addClass to addClasses to support multiple classes @todo anthonydresser invesitgate a better way to do this.
