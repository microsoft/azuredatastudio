...
export abstract class Pane extends Disposable implements IView {
	...
	constructor(options: IPaneOptions) {
		...
		this._orientation = typeof options.orientation === 'undefined' ? Orientation.VERTICAL : options.orientation; // {{ SQL CARBON EDIT }} - Temporary, vscode fixed this for future mergepoint.
