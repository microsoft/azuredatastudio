...
export class MenuId {
	...
	static readonly NotebookExplorerContext = new MenuId('NotebookExplorerContext'); // {{SQL CARBON EDIT}}
	static readonly NotebookExplorerAction = new MenuId('NotebookExplorerAction'); // {{SQL CARBON EDIT}}
