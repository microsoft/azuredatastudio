...
export const defaultButtonStyles: IButtonStyles = {
	...
	buttonDisabledBackground: asCssVariable(buttonDisabledBackground),
	buttonDisabledForeground: asCssVariable(buttonDisabledForeground),
	buttonDisabledBorder: asCssVariable(buttonDisabledBorder)
	// {{SQL CARBON EDIT}} - End
};
