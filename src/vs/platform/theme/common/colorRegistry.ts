...
export const buttonStandardHoverColor = registerColor('buttonStandardHover', { light: '#0078D4', dark: '#000', hc: '#000' }, nls.localize('buttonStandardHover', "The hover color for standard buttons"));
