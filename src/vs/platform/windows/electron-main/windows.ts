...
import { OpenContext, IWindowConfiguration, INativeOpenDialogOptions, IEnterWorkspaceResult, IMessageBoxResult, IURIToOpen } from 'vs/platform/windows/common/windows';
