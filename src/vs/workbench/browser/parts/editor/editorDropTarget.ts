...
class DropOverlay extends Themable {
	...
	private handleDrop(event: DragEvent, splitDirection?: GroupDirection): void {
		...
		// Check for URI transfer
			...
			if (untitledOrFileResources[0].resource.scheme === 'Column' || untitledOrFileResources[0].resource.scheme === 'Table' || untitledOrFileResources[0].resource.scheme === 'View' || untitledOrFileResources[0].resource.scheme === 'Folder') {
