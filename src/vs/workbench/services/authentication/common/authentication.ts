...
export interface IAuthenticationService {
	...
	removeAccountSessions(providerId: string, accountName: string, sessions: AuthenticationSession[], updateAccountList: () => Promise<void> | undefined): Promise<void>; // {{SQL CARBON EDIT}} - Added updatedAccountList delegate to update the accounts pane
}
...
export interface IAuthenticationProvider {
	...
	removeAccountSessions(accountName: string, sessions: AuthenticationSession[], updateAccountList: () => Promise<void> | undefined): Promise<void>; // {{SQL CARBON EDIT}} - Added updateAccountList delegate to update the accounts pane
