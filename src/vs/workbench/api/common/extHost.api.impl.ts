	...
	return function (extension: IExtensionDescription, extensionInfo: IExtensionRegistries, configProvider: ExtHostConfigProvider): typeof vscode {
		...
		const window: typeof vscode.window = {
			...
			showNotebookDocument(document, options?) {
				checkVSCodeNotebooksEnabled(extension); // {{SQL CARBON EDIT}} - add check
		...
		const debug: typeof vscode.debug = {
			...
			get stackFrameFocus() {
				extHostLogService.warn('Debug API is disabled in Azure Data Studio');
				return undefined!;
				// return extHostDebugService.stackFrameFocus;  {{SQL CARBON EDIT}} Removed
			},
			...
			onDidChangeStackFrameFocus(listener, thisArg?, disposables?) {
				extHostLogService.warn('Debug API is disabled in Azure Data Studio');
				return undefined!;
				// return extHostDebugService.onDidChangeStackFrameFocus(listener, thisArg, disposables); {{SQL CARBON EDIT}} Removed
			},
