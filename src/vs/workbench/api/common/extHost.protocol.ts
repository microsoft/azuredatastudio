...
import {
	MainThreadAccountManagementShape, MainThreadAzureAccountShape, MainThreadAzureBlobShape,
	...
	MainThreadObjectExplorerShape, MainThreadQueryEditorShape, MainThreadResourceProviderShape, MainThreadErrorHandlerShape, MainThreadTasksShape,
	...
	ExtHostDataProtocolShape, ExtHostObjectExplorerShape, ExtHostResourceProviderShape, ExtHostErrorHandlerShape, ExtHostModalDialogsShape, ExtHostTasksShape,
...
// {{SQL CARBON EDIT}} - SQL extension proxy definitions, definitions must load in same order in both
// main thread and extension host relative to vscode definitions to avoid RPC problems
export const SqlMainContext = {
	...
	MainThreadErrorHandler: createProxyIdentifier<MainThreadErrorHandlerShape>('MainThreadErrorHandler'),
	...
	MainThreadNotebook: createProxyIdentifier<SqlMainThreadNotebookShape>('MainThreadNotebook'),
...
export const SqlExtHostContext = {
	...
	ExtHostErrorHandler: createProxyIdentifier<ExtHostErrorHandlerShape>('ExtHostErrorHandler'),
	...
	ExtHostNotebook: createProxyIdentifier<SqlExtHostNotebookShape>('ExtHostNotebook'),
