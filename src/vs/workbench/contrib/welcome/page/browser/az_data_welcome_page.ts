			...
			<div class="splash">
				<div class="section start">
					...
					<ul>
						...
						<li><a href="command:workbench.action.files.openLocalFileFolder">${escape(localize('welcomePage.openFile', "Open file"))}</a></li>
					</ul>
				</div>
