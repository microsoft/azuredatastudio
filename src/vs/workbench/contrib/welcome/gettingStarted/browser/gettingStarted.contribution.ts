...
// import { IEditorGroupsService } from 'vs/workbench/services/editor/common/editorGroupsService'; {{SQL CARBON EDIT}} Remove unused
...
/* {{SQL CARBON EDIT}} We don't use the walkthrough actions
