...
function registerCommandsAndActions(): void {
	...
	registerDebugToolBarItem(CONTINUE_ID, CONTINUE_LABEL, 10, ThemeIcon.fromCodicon(icons.debugContinue), CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
	registerDebugToolBarItem(PAUSE_ID, PAUSE_LABEL, 10, ThemeIcon.fromCodicon(icons.debugPause), CONTEXT_DEBUG_STATE.notEqualsTo('stopped'), CONTEXT_DEBUG_STATE.isEqualTo('running'));
	registerDebugToolBarItem(STOP_ID, STOP_LABEL, 70, ThemeIcon.fromCodicon(icons.debugStop), CONTEXT_FOCUSED_SESSION_IS_ATTACH.toNegated());
	registerDebugToolBarItem(DISCONNECT_ID, DISCONNECT_LABEL, 70, ThemeIcon.fromCodicon(icons.debugDisconnect), CONTEXT_FOCUSED_SESSION_IS_ATTACH);
	registerDebugToolBarItem(STEP_OVER_ID, STEP_OVER_LABEL, 20, ThemeIcon.fromCodicon(icons.debugStepOver), undefined, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
	registerDebugToolBarItem(STEP_INTO_ID, STEP_INTO_LABEL, 30, ThemeIcon.fromCodicon(icons.debugStepInto), undefined, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
	registerDebugToolBarItem(STEP_OUT_ID, STEP_OUT_LABEL, 40, ThemeIcon.fromCodicon(icons.debugStepOut), undefined, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
	registerDebugToolBarItem(RESTART_SESSION_ID, RESTART_LABEL, 60, ThemeIcon.fromCodicon(icons.debugRestart));
	registerDebugToolBarItem(STEP_BACK_ID, nls.localize('stepBackDebug', "Step Back"), 50, ThemeIcon.fromCodicon(icons.debugStepBack), CONTEXT_STEP_BACK_SUPPORTED, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
	registerDebugToolBarItem(REVERSE_CONTINUE_ID, nls.localize('reverseContinue', "Reverse"), 60, ThemeIcon.fromCodicon(icons.debugReverseContinue), CONTEXT_STEP_BACK_SUPPORTED, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
...
function registerDebugPanel(): void {
	...
	const VIEW_CONTAINER: ViewContainer = Registry.as<IViewContainersRegistry>(ViewExtensions.ViewContainersRegistry).registerViewContainer({
		...
		icon: ThemeIcon.fromCodicon(icons.debugConsoleViewIcon),
	...
	Registry.as<IViewsRegistry>(ViewExtensions.ViewsRegistry).registerViews([{
		id: REPL_VIEW_ID,
		name: nls.localize({ comment: ['Debug is a noun in this context, not a verb.'], key: 'debugPanel' }, 'Debug Console'),
		containerIcon: ThemeIcon.fromCodicon(icons.debugConsoleViewIcon),
...
function registerDebugView(): void {
	const viewContainer = Registry.as<IViewContainersRegistry>(ViewExtensions.ViewContainersRegistry).registerViewContainer({
		...
		icon: ThemeIcon.fromCodicon(icons.runViewIcon),
	...
	viewsRegistry.registerViews([{ id: VARIABLES_VIEW_ID, name: nls.localize('variables', "Variables"), containerIcon: ThemeIcon.fromCodicon(icons.variablesViewIcon), ctorDescriptor: new SyncDescriptor(VariablesView), order: 10, weight: 40, canToggleVisibility: true, canMoveView: true, focusCommand: { id: 'workbench.debug.action.focusVariablesView' }, when: CONTEXT_DEBUG_UX.isEqualTo('default') }], viewContainer);
	viewsRegistry.registerViews([{ id: WATCH_VIEW_ID, name: nls.localize('watch', "Watch"), containerIcon: ThemeIcon.fromCodicon(icons.watchViewIcon), ctorDescriptor: new SyncDescriptor(WatchExpressionsView), order: 20, weight: 10, canToggleVisibility: true, canMoveView: true, focusCommand: { id: 'workbench.debug.action.focusWatchView' }, when: CONTEXT_DEBUG_UX.isEqualTo('default') }], viewContainer);
	viewsRegistry.registerViews([{ id: CALLSTACK_VIEW_ID, name: nls.localize('callStack', "Call Stack"), containerIcon: ThemeIcon.fromCodicon(icons.callStackViewIcon), ctorDescriptor: new SyncDescriptor(CallStackView), order: 30, weight: 30, canToggleVisibility: true, canMoveView: true, focusCommand: { id: 'workbench.debug.action.focusCallStackView' }, when: CONTEXT_DEBUG_UX.isEqualTo('default') }], viewContainer);
	viewsRegistry.registerViews([{ id: BREAKPOINTS_VIEW_ID, name: nls.localize('breakpoints', "Breakpoints"), containerIcon: ThemeIcon.fromCodicon(icons.breakpointsViewIcon), ctorDescriptor: new SyncDescriptor(BreakpointsView), order: 40, weight: 20, canToggleVisibility: true, canMoveView: true, focusCommand: { id: 'workbench.debug.action.focusBreakpointsView' }, when: ContextKeyExpr.or(CONTEXT_BREAKPOINTS_EXIST, CONTEXT_DEBUG_UX.isEqualTo('default')) }], viewContainer);
	viewsRegistry.registerViews([{ id: WelcomeView.ID, name: WelcomeView.LABEL, containerIcon: ThemeIcon.fromCodicon(icons.runViewIcon), ctorDescriptor: new SyncDescriptor(WelcomeView), order: 1, weight: 40, canToggleVisibility: true, when: CONTEXT_DEBUG_UX.isEqualTo('simple') }], viewContainer);
