...
import { UpdateAction, ManageExtensionAction, ReloadAction, StatusLabelAction, RemoteInstallAction, SystemDisabledWarningAction, ExtensionToolTipAction, LocalInstallAction, ActionWithDropDownAction, InstallDropdownAction, InstallingLabelAction, ExtensionActionWithDropdownActionViewItem, ExtensionDropDownAction, WebInstallAction } from 'vs/workbench/contrib/extensions/browser/extensionsActions';
...
export class Renderer implements IPagedRenderer<IExtension, ITemplateData> {
	...
	renderTemplate(root: HTMLElement): ITemplateData {
		...
		return {
			root, element, icon, name, /*installCount, ratings, */author, description, workspaceTrustDescription, disposables: [disposable], actionbar, // {{SQL CARBON EDIT}} Remove unused options
