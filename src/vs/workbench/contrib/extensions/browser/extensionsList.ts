...
import { RatingsWidget, RecommendationWidget, RemoteBadgeWidget, ExtensionPackCountWidget as ExtensionPackBadgeWidget, SyncIgnoredWidget, ExtensionHoverWidget, ExtensionActivationStatusWidget, PreReleaseBookmarkWidget, extensionVerifiedPublisherIconColor, RunningPreReleaseVersionIndicatorWidget } from 'vs/workbench/contrib/extensions/browser/extensionsWidgets';
