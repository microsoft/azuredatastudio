...
registry.registerWorkbenchAction(SyncActionDescriptor.from(ReopenResourcesAction), 'File: Reopen With...', category.value);
...
registry.registerWorkbenchAction(SyncActionDescriptor.from(GlobalNewUntitledPlainFileAction), 'File: New Plain Text File', category.value); // {{SQL CARBON EDIT}} -- Add 'New File' command for plain untitled files
