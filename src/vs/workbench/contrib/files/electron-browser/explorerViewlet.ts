...
import { ExplorerView } from 'vs/workbench/contrib/files/electron-browser/views/explorerView';
import { EmptyView } from 'vs/workbench/contrib/files/electron-browser/views/emptyView';
import { OpenEditorsView } from 'vs/workbench/contrib/files/electron-browser/views/openEditorsView';
