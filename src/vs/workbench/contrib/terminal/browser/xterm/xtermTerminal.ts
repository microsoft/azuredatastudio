...
export class XtermTerminal extends DisposableStore implements IXtermTerminal, IInternalXtermTerminal {
	...
	*getBufferReverseIterator(): IterableIterator<string> {
	...
	constructor(
		...
		this._shellIntegrationAddon = this._instantiationService.createInstance(ShellIntegrationAddon, disableShellIntegrationReporting, this._telemetryService, this._logService); // {{SQL CARBON EDIT}} - add logService
