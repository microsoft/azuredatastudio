...
import { AccessibilityTextService } from 'sql/platform/accessibility/common/accessibilityTextService';
...
registerSingleton(IAccessibilityTextService, AccessibilityTextService);
