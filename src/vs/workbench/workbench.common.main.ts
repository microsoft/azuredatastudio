...
import { ServerMetadataService } from 'sql/workbench/services/metadata/common/serverMetadataService';
...
registerSingleton(IServerMetadataService, ServerMetadataService, InstantiationType.Eager);
