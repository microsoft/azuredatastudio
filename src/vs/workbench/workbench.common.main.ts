...
import { UrlBrowserDialogController } from 'sql/workbench/services/fileBrowser/browser/urlBrowserDialogController';
...
registerSingleton(IUrlBrowserDialogController, UrlBrowserDialogController);
