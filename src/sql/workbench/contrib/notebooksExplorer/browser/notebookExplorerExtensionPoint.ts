...
import { VIEWLET_ID } from 'sql/workbench/contrib/notebooksExplorer/browser/notebookExplorerViewlet';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { ICustomViewDescriptor } from 'sql/workbench/common/views';
...
const notebookExplorerContribution: IJSONSchema = {
	...
	properties: {
		'notebookExplorer': {
			description: localize('extension.notebookExplorer', "Contributes views to Notebook Explorer container in the Activity bar"),
			type: 'array',
	...
	additionalProperties: {
		description: localize('notebookExplorer.contributed', "Contributes views to contributed views container"),
		type: 'array',
		items: viewDescriptor,
		default: []
	}
...
const notebookExplorerExtensionPoint: IExtensionPoint<{ [loc: string]: IUserFriendlyViewDescriptor[] }> = ExtensionsRegistry.registerExtensionPoint<{ [loc: string]: IUserFriendlyViewDescriptor[] }>({ extensionPoint: 'notebookExplorer', jsonSchema: notebookExplorerContribution });

export class NotebookExplorerContainerExtensionHandler implements IWorkbenchContribution {
	...
	private handleAndRegisterCustomViews() {
		notebookExplorerExtensionPoint.setHandler(extensions => {
