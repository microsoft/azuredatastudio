...
import { NotebookExplorerViewletViewsContribution, OpenNotebookExplorerViewletAction } from 'sql/workbench/contrib/notebooksExplorer/browser/notebookExplorerViewlet';
