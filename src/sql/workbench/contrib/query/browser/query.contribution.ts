...
import { TimeElapsedStatusBarContributions, RowCountStatusBarContributions, QueryStatusStatusBarContributions, QueryResultSelectionSummaryStatusBarContribution, QueryResultsEditorOutputStatusModeContribution } from 'sql/workbench/contrib/query/browser/statusBarItems';
...
workbenchRegistry.registerWorkbenchContribution(QueryResultsEditorOutputStatusModeContribution, LifecyclePhase.Restored);
