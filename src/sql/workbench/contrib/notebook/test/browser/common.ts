...
import { INotebookEditor, INotebookSection, INotebookParams, ICellEditorProvider } from 'sql/workbench/services/notebook/browser/notebookService';
...
export class NotebookComponentStub implements INotebookEditor {
	...
	get cellEditors(): ICellEditorProvider[] {
		throw new Error('Method not implemented.');
	}
