...
import { BookTree, BookTreeElement } from 'sql/workbench/contrib/notebook/browser/notebookExplorer/bookTree';
...
export interface INotebookTreeView {
	readonly tree: ITree | BookTree;
	...
	getSelection(): Array<BookTreeElement>;
	isFocused(): boolean;
	refreshElement(node: TreeNode): Promise<void>;
	readonly treeActionProvider: ServerTreeActionProvider;
	isExpanded(node?: BookTreeElement): boolean;
	reveal(node: BookTreeElement): Promise<void>;
	setExpandedState(node: BookTreeElement, state?: TreeItemCollapsibleState): Promise<void>;
	setSelected(node: BookTreeElement, selected?: boolean, clearOtherSelections?: boolean): Promise<void>;
...
export interface IObjectExplorerService {
	...
	registerServerTreeView(view: INotebookTreeView): void;
	...
	getServerTreeView(): INotebookTreeView | undefined;
...
export class ObjectExplorerService implements IObjectExplorerService {
	...
	private _serverTreeView?: INotebookTreeView;
	...
	public registerServerTreeView(view: INotebookTreeView): void {
