...
import { IObjectExplorerService, INotebookTreeView } from 'sql/workbench/contrib/notebook/browser/notebookExplorer/notebookExplorerService';
 ...
 */
export class NotebookTreeView extends Disposable implements INotebookTreeView {
