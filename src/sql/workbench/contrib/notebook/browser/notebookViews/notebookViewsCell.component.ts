...
@Component({
	...
	templateUrl: decodeURI(require.toUrl('./notebookViewsCell.component.html'))
})
export class NotebookViewsCellComponent extends AngularDisposable implements OnInit {
