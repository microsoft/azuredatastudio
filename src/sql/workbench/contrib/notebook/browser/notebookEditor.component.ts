...
export class NotebookEditorComponent extends AngularDisposable {
	...
	private fillInActionsForCurrentContext(): void {
		...
		fillInActions(groups, { primary, secondary }, false, undefined, Number.MAX_SAFE_INTEGER, (action: SubmenuAction, group: string, groupSize: number) => group === undefined || group === '');
	}
