 ...
 */
export class TableDesignerBaseTextEditor extends BaseTextEditor {

	public static ID = 'designer.editors.baseTextEditor';
	constructor(
		...
		super(TableDesignerBaseTextEditor.ID, telemetryService, instantiationService, storageService, configurationService, themeService, editorService, editorGroupService);
	}
