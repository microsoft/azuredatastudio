			...
			<div class="gradient">
				<div class="preview_text tool_tip">
					<div class="tool_tip_container" id="tool_tip_container_wide">
						<a class="ads_welcome_page_link" aria-describedby="tooltip_text_wide" id="preview_link_wide" class="preview_link" tabindex="0" name="preview"><p>Preview</p><i class="icon_info themed_icon"></i></a>
					...
					<div class="tool_tip_container" id="tool_tip_container_narrow">
						<a class="ads_welcome_page_link" aria-haspopup="true" class="preview_link" tabindex="0" id="preview_link_narrow" name="previewNarrow"><p>Preview</p><i class="icon_info themed_icon"></i></a>
					</div>
				</div>
				...
				<div class="ads_homepage_section section header hero">
										...
										<div>
											...
											<nav role="navigation" class="dropdown_nav">
												<ul id="dropdown" class="dropdown-content" aria-hidden="true" aria-label="submenu" role="menu" aria-labelledby="dropdown_btn">
													<li role="none"><a class="ads_welcome_page_link" role="menuitem" tabIndex="-1" class="move" href="command:registeredServers.addConnection">${escape(localize('welcomePage.newConnection', "New connection"))}</a></li>
													<li role="none"><a class="ads_welcome_page_link" role="menuitem" tabIndex="-1" class="move" href="command:workbench.action.files.newUntitledFile">${escape(localize('welcomePage.newQuery', "New query"))}</a></li>
													<li role="none"><a class="ads_welcome_page_link" role="menuitem" tabIndex="-1" class="move" href="command:notebook.command.new">${escape(localize('welcomePage.newNotebook', "New notebook"))}</a></li>
													<li role="none" id="dropdown_mac_only"><a class="ads_welcome_page_link" role="menuitem" tabIndex="-1" class="move mac_only" href="command:workbench.action.files.openLocalFileFolder">${escape(localize('welcomePage.openFileMac', "Open file"))}</a></li>
													<li role="none" id="dropdown_windows_linux_only"><a class="ads_welcome_page_link" role="menuitem" tabIndex="-1" class="move windows_only linux_only" href="command:workbench.action.files.openFile">${escape(localize('welcomePage.openFileLinuxPC', "Open file"))}</a></li>
												</ul>
											</nav>
										</div>
					...
					<div class="row header_bottom_nav_tiles ads_grid">
						<div class="col">
							<a class="header_bottom_nav_tile_link ads_welcome_page_link" href="command:registeredServers.addConnection">
						...
						<div class="col">
							<a class="header_bottom_nav_tile_link ads_welcome_page_link"
						...
						<div class="col">
							<a class="header_bottom_nav_tile_link ads_welcome_page_link" href="command:notebook.command.new">
						...
						<div class="col">
							<a class="header_bottom_nav_tile_link ads_welcome_page_link" href="command:azdata.resource.deploy">
						...
						<div class="panel">
							<div class="recent history">
								...
								<ul class="moreRecent_list">
									<li class="moreRecent">
										<a class="ads_welcome_page_link" href="command:workbench.action.openRecent">${escape(localize('welcomePage.moreRecent', "Show more"))}
				...
				<div class="getting_started_container">
					<div class="links">
						...
						<div class="link_header">
							<a class="link ads_welcome_page_link"
		...
		"Discover the capabilities offered by Aure Data Studio and learn how to make the most of them."))}
			...
			"Documentation"))}<span class="icon_link themed_icon_alt"</a></a>
				...
				"Visit the documentation center for quickstarts, how-to guides, and references for PowerShell, APIs, etc."))}
						...
						<div class="videos_container row">
							...
							<div class="flex flex_container_video">
								<div class="videos_container_video">
									<a href="https://www.youtube.com/watch?v=Orv7fptVoUA" class="video overview ads_welcome_page_link">
					...
					"Overview of Azure Data Studio"))}</h4>
								...
								<div class="videos_container_video">
									<a href="https://www.youtube.com/watch?v=Nt4kIHQ0IOc" class="video overview ads_welcome_page_link">
			...
			<div class="ads_homepage_section content extensions">
				<div class="flex flex_j_between">
					...
					<a class="link_show_all flex ads_welcome_page_link" href="command:extensions.listView.focus">${escape(localize('welcomePage.showAll', "Show All"))} <span class="icon_arrow_right"></span></a>
				</div>
				<div class="row ads_grid grip_gap_50">
					<div
						...
						<div class="extension_pack_extensions flex flex_d_column flex_j_evenly flex_a_start">
							...
							<a class="a_self_end link_learn_more flex flex_a_center ads_welcome_page_link" href="command:azdata.extension.open?%7B%22id%22%3A%22microsoft.admin-pack%22%7D">${escape(localize('welcomePage.learnMore',
