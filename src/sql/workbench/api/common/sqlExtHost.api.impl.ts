	...
	return {
		azdata: function (extension: IExtensionDescription): typeof azdata {
			...
			const window: typeof azdata.window = {
				...
				openBackupUrlBrowserDialog(defaultBackupName: string, isRestore: boolean): Thenable<string | undefined> {
					return extHostWindow.$openBackupUrlBrowserDialog(defaultBackupName, isRestore);
				}
			};
