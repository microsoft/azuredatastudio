	...
	return {
		azdata: function (extension: IExtensionDescription): typeof azdata {
			...
			const window: typeof azdata.window = {
				...
				createModelViewDialog(title: string, dialogName?: string, width?: boolean | sqlExtHostTypes.DialogWidth, dialogStyle?: sqlExtHostTypes.DialogStyle, dialogPosition?: sqlExtHostTypes.DialogPosition, suppressHeader?: boolean, suppressFooter?: boolean): azdata.window.Dialog {
					...
					return extHostModelViewDialog.createDialog(title, dialogName, extension, dialogWidth, dialogStyle, dialogPosition, suppressHeader, suppressFooter);
				},
