...
export abstract class ExtHostDataProtocolShape {
	 ...
	 */
	$runQuery(handle: number, ownerUri: string, selection: azdata.ISelectionData, runOptions?: azdata.ExecutionPlanOptions, queryResultsDisplayMode?: string): Thenable<void> { throw ni(); }
	/**
