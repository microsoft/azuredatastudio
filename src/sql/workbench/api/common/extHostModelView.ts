...
class ComponentWrapper extends Disposable implements azdata.Component {
	...
	public getDisposableEmitter<T>(): Emitter<T> {
...
class CardWrapper extends ComponentWrapper implements azdata.CardComponent {
	...
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidClick, this.getDisposableEmitter<any>());
	}
...
class InputBoxWrapper extends ComponentWrapper implements azdata.InputBoxComponent {
	...
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onEnterKeyPressed, this.getDisposableEmitter<string>());
	}
...
class WebViewWrapper extends ComponentWrapper implements azdata.WebViewComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, private _extensionLocation: URI, logService: ILogService) {
		...
		this._emitterMap.set(ComponentEventType.onMessage, this.getDisposableEmitter<any>());
	}
...
class EditorWrapper extends ComponentWrapper implements azdata.EditorComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onComponentCreated, this.getDisposableEmitter<any>());
	}
...
class RadioButtonWrapper extends ComponentWrapper implements azdata.RadioButtonComponent {
	...
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidClick, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<boolean>());
	}
...
class TableComponentWrapper extends ComponentWrapper implements azdata.TableComponent {
	...
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onSelectedRowChanged, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onCellAction, this.getDisposableEmitter<any>());
	}
...
class DeclarativeTableWrapper extends ComponentWrapper implements azdata.DeclarativeTableComponent {
	...
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onSelectedRowChanged, this.getDisposableEmitter<azdata.DeclarativeTableRowSelectedEvent>());
...
class RadioCardGroupComponentWrapper extends ComponentWrapper implements azdata.RadioCardGroupComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<azdata.RadioCardSelectionChangedEvent>());
		this._emitterMap.set(ComponentEventType.onDidClick, this.getDisposableEmitter<azdata.RadioCardLinkClickEvent>());
	}
...
class ListViewComponentWrapper extends ComponentWrapper implements azdata.ListViewComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this._emitterMap.set(ComponentEventType.onDidClick, this.getDisposableEmitter<azdata.ListViewClickEvent>());
	}
...
class TabbedPanelComponentWrapper extends ComponentWrapper implements azdata.TabbedPanelComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<string>());
	}
...
class InfoBoxComponentWrapper extends ComponentWrapper implements azdata.InfoBoxComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidClick, this.getDisposableEmitter<any>());
		this._emitterMap.set(ComponentEventType.onChildClick, this.getDisposableEmitter<any>());
	}
...
class SliderComponentWrapper extends ComponentWrapper implements azdata.SliderComponent {
	constructor(proxy: MainThreadModelViewShape, handle: number, id: string, logService: ILogService) {
		...
		this.properties = {};
		this._emitterMap.set(ComponentEventType.onDidChange, this.getDisposableEmitter<number>());
		this._emitterMap.set(ComponentEventType.onInput, this.getDisposableEmitter<number>());
	}
