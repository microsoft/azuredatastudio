...
export class MainThreadDataProtocol implements MainThreadDataProtocolShape {
	...
	public $onResultSetUpdate(handle: number, resultSetInfo: sqlops.QueryExecuteResultSetNotificationParams): void {
		this._queryManagementService.onResultSetUpdate(resultSetInfo);
	}
