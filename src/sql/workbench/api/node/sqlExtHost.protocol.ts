...
export interface MainThreadConnectionManagementShape extends IDisposable {
	...
	$openConnectionDialog(providers: string[], initialConnectionProfile?: azdata.IConnectionProfile, connectionCompletionOptions?: azdata.IConnectionCompletionOptions, isCMSDialog?: boolean): Thenable<azdata.connection.Connection>;
