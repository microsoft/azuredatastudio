...
import { CustomDialogService } from 'sql/workbench/contrib/dialog/browser/customDialogService';
import { Dialog, DialogTab, Wizard } from 'sql/workbench/contrib/dialog/common/dialogTypes';
import { ExtHostModelViewDialogShape } from 'sql/workbench/api/common/sqlExtHost.protocol';
import { Emitter } from 'vs/base/common/event';
import { TestInstantiationService } from 'vs/platform/instantiation/test/common/instantiationServiceMock';
import { TestDialogModal } from 'sql/workbench/contrib/dialog/test/browser/testDialogModal';
