...
import { NewDashboardTabDialog } from 'sql/workbench/services/dashboard/electron-browser/newDashboardTabDialogImpl';
import { IDashboardTab } from 'sql/platform/dashboard/electron-browser/dashboardRegistry';
import { IAngularEventingService, AngularEventType } from 'sql/platform/angularEventing/common/angularEventingService';
import { IDashboardUITab } from 'sql/workbench/services/dashboard/electron-browser/newDashboardTabViewModel';
