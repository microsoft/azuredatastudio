...
import { CustomDialogService } from 'sql/workbench/parts/dialog/browser/customDialogService';
import { Dialog, DialogTab, Wizard } from 'sql/workbench/parts/dialog/common/dialogTypes';
