...
export class FirewallRuleDialogController {
	...
	private _connection: ConnectionProfile;
	 ...
	 */
	public openFirewallRuleDialog(connection: ConnectionProfile, ipAddress: string, resourceProviderId: string): Promise<boolean> {
