...
import { WidgetConfig, TabConfig, NavSectionConfig } from 'sql/workbench/parts/dashboard/electron-browser/core/dashboardWidget';
...
import { DashboardTab, IConfigModifierCollection } from 'sql/workbench/parts/dashboard/electron-browser/core/interfaces';
import { WIDGETS_CONTAINER } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardWidgetContainer.contribution';
import { GRID_CONTAINER } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardGridContainer.contribution';
import * as dashboardHelper from 'sql/workbench/parts/dashboard/electron-browser/core/dashboardHelper';
