...
import 'sql/workbench/parts/dashboard/electron-browser/core/dashboardPanelStyles';
...
import { WidgetConfig, TabConfig, TabSettingConfig } from 'sql/workbench/parts/dashboard/electron-browser/core/dashboardWidget';
import { IPropertiesConfig } from 'sql/workbench/parts/dashboard/electron-browser/pages/serverDashboardPage.contribution';
import { PanelComponent } from 'sql/base/electron-browser/ui/panel/panel.component';
import { IDashboardRegistry, Extensions as DashboardExtensions, IDashboardTab } from 'sql/platform/dashboard/electron-browser/dashboardRegistry';
