...
/* Services */
import { BreadcrumbService } from 'sql/workbench/parts/dashboard/electron-browser/services/breadcrumb.service';
...
/* Base Components */
import { DashboardComponent } from 'sql/workbench/parts/dashboard/electron-browser/dashboard.component';
...
import { DashboardWidgetContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardWidgetContainer.component';
import { DashboardGridContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardGridContainer.component';
...
import { DashboardModelViewContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardModelViewContainer.component';
import { DashboardErrorContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardErrorContainer.component';
import { DashboardNavSection } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardNavSection.component';
...
import { DashboardHomeContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardHomeContainer.component';
import { ControlHostContent } from 'sql/workbench/parts/dashboard/electron-browser/contents/controlHostContent.component';
import { DashboardControlHostContainer } from 'sql/workbench/parts/dashboard/electron-browser/containers/dashboardControlHostContainer.component';
...
/* Pages */
import { ServerDashboardPage } from 'sql/workbench/parts/dashboard/electron-browser/pages/serverDashboardPage.component';
import { DatabaseDashboardPage } from 'sql/workbench/parts/dashboard/electron-browser/pages/databaseDashboardPage.component';
...
import { ExplorerWidget } from 'sql/workbench/parts/dashboard/electron-browser/widgets/explorer/explorerWidget.component';
import { TasksWidget } from 'sql/workbench/parts/dashboard/electron-browser/widgets/tasks/tasksWidget.component';
import { InsightsWidget } from 'sql/workbench/parts/dashboard/electron-browser/widgets/insights/insightsWidget.component';
