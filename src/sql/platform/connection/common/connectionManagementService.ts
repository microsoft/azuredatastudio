...
export class ConnectionManagementService extends Disposable implements IConnectionManagementService {
	 ...
	 */
	public showConnectionDialog(params?: INewConnectionParams, model?: IConnectionProfile, connectionResult?: IConnectionResult, cmsDialog: azdata.CmsDialog = undefined): Promise<void> {
		let self = this;
		return new Promise<void>((resolve, reject) => {
			...
			self._connectionDialogService.showDialog(self, params, model, connectionResult, cmsDialog).then(() => {
				resolve();
			}, dialogError => {
