...
const storedConnection1 = { id: 'asdasdasd1', providerName: 'MSSQL', groupId: storedGroup1.id, options: { serverName: 'server1', databaseName: 'database1', authenticationType: 'password' } };
...
const storedConnection2 = { id: 'asdasdasd2', providerName: 'MSSQL', groupId: storedGroup1.id, options: { serverName: 'server2', databaseName: 'database2', authenticationType: 'password' } };
