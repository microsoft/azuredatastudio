...
suite('SQL ConnectionProfileInfo tests', () => {
	...
	test('getOptionsKey should create a valid unique id', () => {
		let conn = new ConnectionProfile(capabilitiesService, iConnectionProfile);
		let expectedId = 'providerName:MSSQL|authenticationType:|connectionName:new name|databaseName:database|encrypt:|serverName:new server|trustServerCertificate:|userName:user|databaseDisplayName:database|groupId:group id';
