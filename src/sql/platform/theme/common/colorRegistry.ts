...
export const tileBoxShadowHover = registerColor('tileBoxShadowHover', { light: tileBoxShadowHoverColor, dark: tileBoxShadowHoverColor, hc: tileBoxShadowHoverColor }, nls.localize('tileBoxShadowHover', "The tile box shadow color"));
...
export const buttonPrimaryText = registerColor('buttonPrimary', { light: '#fff', dark: '#fff', hc: '#fff' }, nls.localize('buttonPrimaryTextr', "The primary button color"));
...
export const buttonPrimaryBorder = registerColor('buttonPrimaryBackground', { light: '#0078d4', dark: '#0078d4', hc: '#0078d4' }, nls.localize('buttonPrimaryBorder', "The primary button border color"));
...
export const buttonDropdownBoxShadow = registerColor('buttonDropdownBoxShadow', { light: dropdownBoxShadow, dark: dropdownBoxShadow, hc: dropdownBoxShadow }, nls.localize('buttonDropdownBoxShadow', "The button dropdown background color"));
...
export const buttonDropdownBackgroundHover = registerColor('buttonDropdownBackgroundHover', { light: '#efefef', dark: '#252525', hc: '#252525' }, nls.localize('buttonDropdownBackgroundHover', "The button dropdown border color"));
export const extensionPackBorder = registerColor('extensionPackBorder', { light: '#8A8886', dark: '#8A8886', hc: '#2B56F2' }, nls.localize('extensionPackBorder', "The button dropdown border color"));
export const extensionPackHeader = registerColor('extensionPackHeader', { light: '#fff', dark: '#fff', hc: '#fff' }, nls.localize('extensionPackHeader', "The button dropdown border color"));
export const extensionPackBody = registerColor('extensionPackBody', { light: '#fff', dark: '#fff', hc: '#fff' }, nls.localize('extensionPackBody', "The button dropdown border color"));
export const listBorder = registerColor('listBorder', { light: '#ccc', dark: '#ccc', hc: '#ccc' }, nls.localize('listBorder', "The button dropdown border color"));
export const extensionPackHeaderShadow = registerColor('extensionPackHeaderShadow', { light: textShadow, dark: textShadow, hc: textShadow }, nls.localize('extensionPackHeaderShadow', "The button dropdown border color"));
export const extensionPackGradientColorOneColor = registerColor('extensionPackGradientColorOne', { light: extensionPackGradientOne, dark: extensionPackGradientOne, hc: extensionPackGradientOne }, nls.localize('extensionPackGradientColorOne', "The button dropdown border color"));
export const extensionPackGradientColorTwoColor = registerColor('extensionPackGradientColorTwo', { light: extensionPackGradientTwo, dark: extensionPackGradientTwo, hc: extensionPackGradientTwo }, nls.localize('extensionPackGradientColorTwo', "The button dropdown border color"));
...
export const gradientOne = registerColor('gradientOne', { light: '#f0f0f0', dark: gradientOneColorOne, hc: gradientOneColorOne }, nls.localize('gradientOne', "The button dropdown border color"));
export const gradientTwo = registerColor('gradientTwo', { light: gradientTwoColorOne, dark: gradientTwoColorTwo, hc: gradientTwoColorTwo }, nls.localize('gradientTwo', "The button dropdown border color"));
export const gradientBackground = registerColor('gradientBackground', { light: '#fff', dark: 'transparent', hc: 'transparent' }, nls.localize('gradientBackground', "The button dropdown border color"));
...
export const welcomeLinkActive = registerColor('welcomeLinkActive', { light: '#004578', dark: '#004578', hc: '#004578' }, nls.localize('welcomeLinkActive', "Foreground color for links in text."));
export const welcomeLabel = registerColor('welcomeLabel', { light: '#0078d7', dark: '#0078d7', hc: '#0078d7' }, nls.localize('welcomeLabel', "Foreground color for links in text."));
export const welcomeLabelChecked = registerColor('welcomeLabel', { light: '#000', dark: '#fff', hc: '#fff' }, nls.localize('welcomeLabel', "Foreground color for links in text."));
export const welcomeLabelBorder = registerColor('welcomeLabel', { light: '#000', dark: '#fff', hc: '#fff' }, nls.localize('welcomeLabel', "Foreground color for links in text."));
