...
// Query Editor
export const queryEditorNullBackground = registerColor('queryEditor.nullBackground', { light: '#FFFF00', dark: '#0000FF', hcDark: '#0000FF', hcLight: '#FFFF00' }, nls.localize('queryEditorNullBackground', 'The background color for null values in the query editor.'));
