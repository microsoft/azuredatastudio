...
// Query Editor
export const queryEditorNullBackground = registerColor('queryEditor.nullBackground', { light: '#FFFF00', dark: '#4B0082', hcDark: '#4B0082', hcLight: '#FFFF00' }, nls.localize('queryEditorNullBackground', 'The background color for null values in the query editor.'));
