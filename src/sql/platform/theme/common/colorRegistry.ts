...
export const codeCellParameterBackground = registerColor('notebook.codeCellParameterBackground', { light: '#0078D4', dark: '#0078D4', hc: '#0078D4' }, nls.localize('parameterTagBackground', "Parameter background color."));
export const codeCellParameterText = registerColor('notebook.codeCellParameterText', { light: '#FFFFFF', dark: '#FFFFFF', hc: '#FFFFFF' }, nls.localize('parameterTagText', "Parameter text color."));
