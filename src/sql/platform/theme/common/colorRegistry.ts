...
export const buttonSecondary = registerColor('button.secondaryForeground', { light: '#323130', dark: '#fff', hc: '#fff' }, nls.localize('buttonSecondary', "The font color for secondary button"));
export const buttonSecondaryHoverColor = registerColor('buttonSecondaryHover', { light: '#0078D4', dark: '#3794ff', hc: '#3794ff' }, nls.localize('button.secondaryForeground', "The hover color for secondary buttons"));
