...
import { DialogModule } from 'sql/platform/dialog/electron-browser/dialog.module';
import { DialogComponentParams, LayoutRequestParams } from 'sql/platform/dialog/electron-browser/dialogContainer.component';
