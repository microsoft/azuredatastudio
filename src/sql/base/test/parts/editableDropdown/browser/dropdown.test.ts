...
suite('Editable dropdown tests', () => {
	...
	test('changing value through code fires onValueChange event', () => {
		...
		// TypeScript thinks that count will still be 1 even though it's been updated above as part of the
		// dropdown set method --> onValueChange codepath. Therefore, suppressing this error here and below
		// @ts-ignore
