...
export function extensionsWorkbenchServiceIncompatible(extension: string, version: string, requiredVersion: string) { return localize('incompatible', "Unable to install extension '{0}' as it is not compatible with Azure Data Studio '{1}'. Update to Azure Data Studio {2} to install the extension.", extension, version, requiredVersion); }
