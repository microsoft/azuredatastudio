...
export interface IQueryManagementService {
	...
	onResultSetUpdate(resultSetInfo: sqlops.QueryExecuteResultSetNotificationParams): void;
...
export class QueryManagementService implements IQueryManagementService {
	...
	public onResultSetUpdate(resultSetInfo: sqlops.QueryExecuteResultSetNotificationParams): void {
		this._notify(resultSetInfo.ownerUri, (runner: QueryRunner) => {
			runner.handleResultSetUpdate(resultSetInfo);
		});
	}
