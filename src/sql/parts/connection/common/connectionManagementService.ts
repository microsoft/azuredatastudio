...
export class ConnectionManagementService extends Disposable implements IConnectionManagementService {
	...
	private _onLanguageFlavorChanged = new Emitter<data.DidChangeLanguageFlavorParams>();
	...
	constructor(
		...
		this.onConnect(this.refreshEditorTitles, this);
		this.onDisconnect(this.refreshEditorTitles, this);
	}
	...
	public registerProvider(providerId: string, provider: data.ConnectionProvider): void {
		...
		(this._providers.get(providerId).onReady as Deferred<data.ConnectionProvider>).resolve(provider);
	}
