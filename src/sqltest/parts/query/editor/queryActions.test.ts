...
suite('SQL QueryAction Tests', () => {
	...
	test('ListDatabaseItem shows items as expected', (done) => {
		...
		listItem = new ListDatabasesActionItem(editor.object, connectionManagementService.object, undefined, undefined, configurationService.object, undefined);
	...
	test('ListDatabaseItem - null event params', () => {
		...
		let listItem = new ListDatabasesActionItem(editor.object, cms.object, null, null, configurationService.object, undefined);
		listItem.onConnected();
